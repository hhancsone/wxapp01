...
function initRuntimeSocketService() {
  const hosts = "26.13.126.165,192.168.56.1,192.168.179.1,192.168.154.1,192.168.1.102,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_LSOa4T";
...
const pages = [
  ...
  {
    path: "pages/encyclopedia/detail",
    style: {
      navigationStyle: "custom",
      navigationBarTitleText: "药材详情"
    }
  },
  {
  ...
  {
    path: "pages/mine/identify-records",
    style: {
      navigationStyle: "custom",
  ...
  {
    path: "pages/fenlei/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/fenlei/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/fenlei/list",
    style: {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","26.13.126.165","192.168.56.1","192.168.179.1","192.168.154.1","192.168.1.102"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","C:/Users/黄文达/Desktop/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"hwd","spaceId":"mp-cd26c9a6-c5a5-4c83-a96c-85ff377a9b00","clientSecret":"nNcn8XBraEkrGNHk8Up59A==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__EFD900F";
} catch (e2) {
